...
if __name__ == "__main__":
    st.set_page_config(page_title="Swiggy ETA Prediction", 
                       page_icon=None, 
                       layout="centered",
    ...
    st.title("Swiggy ETA Prediction")
    ...
    st.write("""
                The Swiggy ETA prediction model ensures prompt and accurate deliveries in the food industry.
